...
const routerList = [AndroidPAD, Login, calendar, ElectronicScale, BarcodePrinter, InfraredCounterGun, Company, RepairBill, MountGuardRecords, ProcessMaintenance_ProcessFlowMaintenance, PerformanceAndConfig, TodoList];
