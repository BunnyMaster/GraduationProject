  ...
  <HomeTableCommon :tableData="tableData">
    <template #default>
      <el-table :data="tableData" style="width: 100%" stripe :row-class-name="Fun.tableRowClassName" :default-sort="{ prop: 'date', order: 'descending' }" max-height="650">
        ...
        <!--      TODO 产品名称-->
        <el-table-column align="center" prop="date" label="产品名称" width="auto" style="text-align: center" />
        <!--      TODO 产品批次-->
        <el-table-column align="center" prop="date" label="产品批次" width="auto" style="text-align: center" />
        <!--      TODO 工单编号-->
        <el-table-column align="center" prop="date" label="工单编号" width="auto" style="text-align: center" />
        <!--      TODO 详情-->
        <el-table-column align="center" prop="date" label="详情" width="auto" style="text-align: center" />
        <!--  TODO --- 操作   -->
