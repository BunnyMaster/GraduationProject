  ...
  <HomeTableCommon :tableData="tableData">
    <template #default>
      <el-table :data="tableData" style="width: 100%" stripe :row-class-name="Fun.tableRowClassName" :default-sort="{ prop: 'date', order: 'descending' }" max-height="650">
        ...
        <!--      TODO 工序名称-->
        <el-table-column align="center" prop="date" label="工序名称" width="260" style="text-align: center" />
        <!--      TODO 上报问题-->
        <el-table-column align="center" prop="date" label="上报问题" width="400" style="text-align: center" />
        <!--      TODO 上报人-->
        <el-table-column align="center" prop="date" label="上报人" width="180" style="text-align: center" />
        <!--   TODO --- 流程编码  -->
        <el-table-column align="center" sortable prop="date" label="流程编码" width="260" style="text-align: center">
          <template #default="scope">
            <div style="display: flex; justify-content: center; align-items: center">
              <el-icon><timer /></el-icon>
              <span style="margin-left: 10px">{{ scope.row.date }}</span>
        ...
        <!--      TODO 检查结果-->
        <el-table-column align="center" prop="date" label="检查结果" width="120" style="text-align: center" />
        <!--      TODO 检查人-->
        <el-table-column align="center" prop="date" label="检查人" width="150" style="text-align: center" />
        <!--   TODO --- 检查时间  -->
        <el-table-column align="center" sortable prop="date" label="检查时间" width="220" style="text-align: center">
          <template #default="scope">
            <div style="display: flex; justify-content: center; align-items: center">
              <el-icon><timer /></el-icon>
              <span style="margin-left: 10px">{{ scope.row.date }}</span>
