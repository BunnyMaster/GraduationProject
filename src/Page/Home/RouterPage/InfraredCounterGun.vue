  ...
  <HomeTableCommon :tableList="tableList" :tableData="tableData">
    <template #default>
      <el-table :data="tableData" style="width: 100%" stripe :row-class-name="Fun.tableRowClassName" :default-sort="{ prop: 'date', order: 'descending' }" max-height="650">
        ...
        <!--  TODO ---  感应距离  -->
        <el-table-column align="center" prop="address" label="感应距离" :formatter="Fun.formatter" width="400" />
        <!--  TODO ---  感应方式  -->
        <el-table-column align="center" prop="address" label="感应方式" :formatter="Fun.formatter" width="400" />
        <!--   TODO --- 采购时间  -->
