  ...
  <HomeTableCommon :tableData="tableData">
    <template #default>
      <el-table :data="tableData" style="width: 100%" stripe :row-class-name="Fun.tableRowClassName" :default-sort="{ prop: 'date', order: 'descending' }" max-height="650">
        ...
        <!--  TODO ---  工位编码  -->
        <el-table-column align="center" :fixed="'left'" sortable="custom" prop="date" label="工站编号" width="auto" style="text-align: center">
          <template #default="scope">
        ...
        <!--   TODO ---   工站描述-->
        <el-table-column align="center" prop="address" label="工站描述" :formatter="Fun.formatter" width="auto" />
        <!--  TODO --- 操作   -->
