  ...
  >
    <template #default>
      <el-table :data="tableData" style="width: 100%" stripe :row-class-name="Fun.tableRowClassName" :default-sort="{ prop: 'date', order: 'descending' }" max-height="650">
        ...
        <!--      TODO 工站名称-->
        <el-table-column align="center" prop="workstationName" label="工站名称" width="auto" />
        <!--   TODO ---   所属产线-->
        <el-table-column
          align="center"
          prop="LocalName"
        ...
        <!--  TODO ---  工站编号  -->
        <el-table-column align="center" sortable="custom" prop="LocalNumber" label="工站编号" width="auto" style="text-align: center">
          <template #default="scope">
        ...
        <!--   TODO ---   工站负责人-->
        <el-table-column align="center" prop="factoryMainName" label="工站负责人" width="auto" />
      </el-table>
    </template>
  </HomeTableCommon>
</template>
