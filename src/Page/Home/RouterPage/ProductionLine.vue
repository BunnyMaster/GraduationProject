  ...
  >
    <template #default>
      <el-table :data="tableData" style="width: 100%" stripe :row-class-name="Fun.tableRowClassName" :default-sort="{ prop: 'date', order: 'descending' }" max-height="650">
        ...
        <!--   TODO ---   所属工站-->
        <el-table-column align="center" prop="workstationName" label="所属工站" width="auto" />
        <!--  TODO ---  产线编码  -->
        <el-table-column align="center" :fixed="'left'" prop="LocalNumber" label="产线编码" width="auto">
          <template #default="scope">
        ...
        <!--   TODO ---   产线负责人-->
        <el-table-column align="center" prop="factoryMainName" label="产线负责人" width="120" />
      </el-table>
    </template>
  </HomeTableCommon>
</template>
