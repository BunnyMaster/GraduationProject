  ...
  <HomeTableCommon :tableData="tableData">
    <template #default>
      <el-table :data="tableData" style="width: 100%" stripe :row-class-name="Fun.tableRowClassName" :default-sort="{ prop: 'date', order: 'descending' }" max-height="650">
        ...
        <!--  TODO ---  产线编码  -->
        <el-table-column align="center" :fixed="'left'" sortable="custom" prop="date" label="产线编码" width="auto">
          <template #default="scope">
        ...
        <!--   TODO ---   产线描述-->
        <el-table-column align="center" prop="address" label="产线描述" :formatter="Fun.formatter" width="auto" />
        <!--  TODO --- 操作   -->
