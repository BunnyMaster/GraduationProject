  ...
  <HomeTableCommon :tableData="tableData">
    <template #default>
      <el-table :data="tableData" style="width: 100%" stripe :row-class-name="Fun.tableRowClassName" :default-sort="{ prop: 'date', order: 'descending' }" max-height="650">
        ...
        <!--   TODO --- 流程编码  -->
        <el-table-column align="center" sortable prop="date" label="流程编码" width="auto" style="text-align: center">
          <template #default="scope">
            <div style="display: flex; justify-content: center; align-items: center">
              <el-icon><timer /></el-icon>
              <span style="margin-left: 10px">{{ scope.row.date }}</span>
        ...
        <!--      TODO 流程版本-->
        <el-table-column align="center" prop="date" label="流程版本" width="auto" style="text-align: center" />
        <!--      TODO 流程名称-->
        <el-table-column align="center" prop="date" label="流程名称" width="auto" style="text-align: center" />
        <!--      TODO 流程描述-->
        <el-table-column align="center" prop="date" label="流程描述" width="auto" style="text-align: center" />
        <!--  TODO --- 操作   -->
