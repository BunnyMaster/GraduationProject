  ...
  <HomeTableCommon :tableList="tableList" :tableData="tableData">
    <template #default>
      <el-table :data="tableData" style="width: 100%" stripe :row-class-name="Fun.tableRowClassName" :default-sort="{ prop: 'date', order: 'descending' }" max-height="650">
        ...
        <!--  TODO ---  读卡速度  -->
        <el-table-column align="center" prop="name" label="读卡速度" width="120" />
        <!--  TODO ---  打卡间隔  -->
        <el-table-column align="center" prop="name" label="打卡间隔" width="120" />
        <!--  TODO ---  感应距离  -->
        <el-table-column align="center" prop="name" label="感应距离" width="120" />
        <!--  TODO ---  读卡频率  -->
        <el-table-column align="center" prop="name" label="读卡频率" width="120" />
        <!--   TODO --- 采购时间  -->
