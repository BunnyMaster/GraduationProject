  ...
  <HomeTableCommon :tableData="tableData">
    <template #default>
      <el-table :data="tableData" style="width: 100%" stripe :row-class-name="Fun.tableRowClassName" :default-sort="{ prop: 'date', order: 'descending' }" max-height="650">
        ...
        <!--  TODO ---  车间编号  -->
        <el-table-column align="center" :fixed="'left'" sortable="custom" prop="date" label="车间编号" width="auto" style="text-align: center">
          <template #default="scope">
        ...
        <!--   TODO ---   车间描述-->
        <el-table-column align="center" prop="address" label="车间描述" :formatter="Fun.formatter" width="auto" />
        <!--  TODO --- 操作   -->
