  ...
  <HomeTableCommon :tableData="tableData">
    <template #default>
      <el-table :data="tableData" style="width: 100%" stripe :row-class-name="Fun.tableRowClassName" :default-sort="{ prop: 'date', order: 'descending' }" max-height="650">
        ...
        <!--   TODO --- 序号  -->
        <el-table-column align="center" :fixed="'left'" sortable prop="date" label="序号" width="auto" style="text-align: center">
        ...
        <!--   TODO --- 工序编号  -->
        <el-table-column align="center" :fixed="'left'" sortable prop="date" label="工序编号" width="auto" style="text-align: center">
          <template #default="scope">
            <div style="display: flex; justify-content: center; align-items: center">
              <el-icon><timer /></el-icon>
              <span style="margin-left: 10px">{{ scope.row.date }}</span>
        ...
        <!--      TODO 工序描述-->
        <el-table-column align="center" prop="date" label="工序描述" width="auto" style="text-align: center" />
        <!--  TODO --- 操作   -->
