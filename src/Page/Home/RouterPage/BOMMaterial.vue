  ...
  <HomeTableCommon :tableData="tableData">
    <template #default>
      <el-table :data="tableData" style="width: 100%" stripe :row-class-name="Fun.tableRowClassName" :default-sort="{ prop: 'date', order: 'descending' }" max-height="650">
        ...
        <!--      TODO BOM名称-->
        <el-table-column align="center" prop="tag" label="BOM名称" width="auto" />
        <!--   TODO ---   BOM版本-->
        <el-table-column
          align="center"
          :fixed="'left'"
        ...
        <!--   TODO ---   BOM状态-->
        <el-table-column align="center" prop="tag" label="BOM状态" width="auto" />
        <!--   TODO ---   修改时间-->
        <el-table-column align="center" sortable="custom" prop="date" label="修改时间" width="auto" style="text-align: center">
          <template #default="scope">
