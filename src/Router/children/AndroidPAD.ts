...
var AndroidPADMakeLine = new RandomItemMakeLine();
...
Router.get("/AndroidPAD", (request: any, response: any, next: any) => {
  ...
  MYSQL.query(`SELECT * FROM graduation.androidpad limit ${data.index},${data.count};`, (error: any, result: any) => {
    const data = {
      code: 200,
      message: "请求安卓PAD数据成功",
      data: result,
...
Router.post("/AndroidPAD", (request: any, response: any, next: any) => {
  ...
  AndroidPADMakeLine = new RandomItemMakeLine();
  num = uuid.v4();
